...
function build_model_full!(agg, params)
    ...
    E_plab_id!(m, vars, na, nr, no, params)
    E_realwage_id!(m, vars, na, nr, no, params)
    E_xlab_id!(m, vars, na, nr, no, params)
    E_wlab_id!(m, vars, na, nr, no)
    E_rlab_id!(m, vars, na, nr, no)
